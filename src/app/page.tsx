    ...
    <main className="min-h-screen bg-gradient-to-b from-cloud to-sky-50 dark:from-midnight dark:to-teal-900">
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? 'bg-white/90 dark:bg-midnight/90 backdrop-blur-md shadow-md py-2'
            : 'bg-transparent py-4'
        }`}
      >
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            {/* Desktop Navigation */}
            <div className="hidden lg:!hidden md:flex items-center space-x-6">
              <Link
                href="/story"
                className="text-text-secondary dark:text-text-primary hover:text-primary dark:hover:text-primary-light transition-colors"
              >
                Try It Free
              </Link>
              <Link
            ...
            <div className="md:hidden flex items-center">
              ...
              <button
                ...
                className="ml-2 p-2 text-text-secondary dark:text-text-primary"
          ...
          {/* Progress bar */}
          <div className="h-0.5 w-full bg-lavender/20 dark:bg-lavender/10 mt-2">
            <div
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden bg-white dark:bg-midnight border-t border-lavender/10 dark:border-lavender/5"
            >
