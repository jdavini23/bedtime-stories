...
function StoryCard({ title, description, image, author, date }: StoryCardProps) {
  return (
    <Card className="border-0 shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 group bg-white">
