      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Our AI-powered platform creates personalized stories that spark creativity and create
            lasting memories.
          </p>
        </div>
...
function FeatureCard({ icon, title, description, color }: FeatureCardProps) {
  return (
    <Card className="border-0 shadow-xl overflow-hidden h-full transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 bg-white">
