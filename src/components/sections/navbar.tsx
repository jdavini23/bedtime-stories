...
import { Book, Menu as MenuIcon, X } from 'lucide-react';
...
function NavLink({
  ...
  return (
    ...
    >
      {children}
      {active && (
        <div className="absolute bottom-0 left-0 right-0 h-1 mx-4 bg-gradient-to-r from-violet-500 to-indigo-500 rounded-full" />
      )}
    </Link>
  );
}
