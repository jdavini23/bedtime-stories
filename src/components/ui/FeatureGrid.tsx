...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'border-teal/30 shadow-teal/20',
    accent: 'border-golden/30 shadow-golden/20',
  };
  ...
  return (
    ...
    >
      ...
      <h3 className={cn('text-xl font-bold text-center mb-2', themeClasses.text)}>{title}</h3>
      <p className={cn('text-sm text-center', themeClasses.textMuted)}>{description}</p>
    </motion.div>
  );
};
