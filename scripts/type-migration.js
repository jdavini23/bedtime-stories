...
const _replaceFileContent = (filePath, content) => {
...
function migrateTypes() {
  ...
  files.forEach((file) => {
    ...
    const replacements = [
      ...
      [
        /publicMetadata\.preferences\.interests/g,
        'publicMetadata.preferences.mostLikedCharacterTypes',
      ],
      ...
      [
        ...
        (match, content) => {
          const updatedContent = content
            ...
            .replace(
              /mostLikedCharacterTypes: string\[\];/g,
      ...
      [
        ...
        (match, imports) => {
          const cleanImports = imports
            .split(',')
            .map((imp) => imp.trim())
            .filter((imp) => imp === 'UserPersonalizationEngine' || imp === 'DEFAULT_PREFERENCES')
            .join(', ');
