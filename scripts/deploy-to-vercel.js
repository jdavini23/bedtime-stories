...
console.log(`${colors.cyan}This script will prepare and deploy your project to Vercel${colors.reset}\n`);
...
if (packageJson.dependencies['@opentelemetry/api']) {
  ...
  console.log(`${colors.green}✓ Updated @opentelemetry/api from ${currentVersion} to 1.8.0${colors.reset}`);
}
...
try {
  ...
  console.log(`${colors.yellow}! Environment verification script not found or failed${colors.reset}`);
}
